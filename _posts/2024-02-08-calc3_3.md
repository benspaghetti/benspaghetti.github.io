...
We have a $\mathbb{Z}$-graded vector space with an operator $$T^\bullet V := \bigoplus_{k \in \mathbb{Z}} T^k V.$$
...
In the algebra $S^\bullet V$, the minimal spanning set of $S^k V$ is