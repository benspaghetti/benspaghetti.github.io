...
We have 
$$T^0 V \coloneqq \mathbb{F}$$
$$T^1 V \coloneqq V$$ 
$$T^k V \coloneqq \bigotimes_{i=1}^k V_i$$

We have a Z-graded vector space with an operator $$T^\bullet V \coloneqq \bigoplus_{k \in \mathbb{Z}^+} T^k V.$$
...
<!-- % https://q.uiver.app/#q=
\[\begin{tikzcd}
	{u_1\cdot u_2 \cdot\cdots\cdot u_k} & {S^\bullet V \coloneqq T^\bullet V/ \left( I = \mathrm{span}  \{ u\otimes v - v \otimes u : u, v \in V \} \right)} \\
...
Similarly, many algebras we consider are quotients of the tensor algebra.